...
const TicTacToe=(                                                                                                                              )=>{
 ...
 let box_array=[box1,box2,box3,box4,box5,box6,box7,box8,box8,box9]
  ...
  const won =(winner)=>{
    ...
    if(winner==='x')
    {
      titleRef.current.innerHTML=`Congrats:<img src=${cross}>wins`
    }
    else{
      titleRef.current.innerHTML=`Congrats:<img src=${circle}>wins`
